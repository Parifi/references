export const OrderManagerABI = [
  ...
  { inputs: [], name: 'BelowMinCollateral', type: 'error' },
  { inputs: [], name: 'ExistingPosition', type: 'error' },
  { inputs: [], name: 'InactiveMarket', type: 'error' },
  { inputs: [], name: 'InvalidCollateralAmount', type: 'error' },
  { inputs: [], name: 'InvalidLimitOrder', type: 'error' },
  { inputs: [], name: 'InvalidMarketDecimals', type: 'error' },
  { inputs: [], name: 'InvalidMarketId', type: 'error' },
  { inputs: [], name: 'InvalidOrderType', type: 'error' },
  { inputs: [], name: 'InvalidPositionId', type: 'error' },
  {
  ...
  { inputs: [], name: 'LiquidationErrorNoLoss', type: 'error' },
  { inputs: [], name: 'MaxFee', type: 'error' },
  { inputs: [], name: 'OrderDoesNotExist', type: 'error' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'isProfit', type: 'bool' },
      {
        indexed: false,
        internalType: 'uint256',
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'bool', name: 'isLimitOrder', type: 'bool' },
      ...
      { internalType: 'bool', name: 'isRelayed', type: 'bool' },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'totalProfitOrLoss', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_updatedFee', type: 'uint256' }],
    name: 'setPartnerFee',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_newFeeManager', type: 'address' },
    ],
