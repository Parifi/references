export const AdapterABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_dataFabric', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'deltaSize', type: 'uint256' },
      { internalType: 'uint256', name: 'deltaCollateral', type: 'uint256' },
      { internalType: 'uint256', name: 'feesInCollateral', type: 'uint256' },
    ...
    outputs: [{ internalType: 'uint256', name: 'leverage', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'dataFabric',
    outputs: [
      { internalType: 'contract IDataFabric', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'netProfitOrLoss', type: 'uint256' },
      { internalType: 'bool', name: 'isNetProfit', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'netProfitOrLoss', type: 'uint256' },
      { internalType: 'bool', name: 'isNetProfit', type: 'bool' },
      { internalType: 'bool', name: 'canLiquidate', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'getNetPNLInUsd',
    outputs: [
      { internalType: 'uint256', name: 'netProfitOrLossUsd', type: 'uint256' },
      { internalType: 'uint256', name: 'pnlInUsd', type: 'uint256' },
      { internalType: 'uint256', name: 'feeInUsd', type: 'uint256' },
      {
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'accruedBorrowFees', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'profitOrLoss', type: 'uint256' },
