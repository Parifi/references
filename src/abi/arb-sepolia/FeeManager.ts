export const FeeManagerABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_chunkSize', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_lpShare', type: 'uint256' },
      { internalType: 'uint256', name: '_protocolShare', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_token', type: 'address' },
      { internalType: 'address', name: '_lpFeeReceiver', type: 'address' },
    ],
