export const DataFabricABI = [
  {
    inputs: [{ internalType: 'address', name: '_rbac', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  { inputs: [], name: 'AlreadyInitialized', type: 'error' },
  { inputs: [], name: 'CloseOnlyMode', type: 'error' },
  ...
  { inputs: [], name: 'MarketIsActive', type: 'error' },
  { inputs: [], name: 'MaxFee', type: 'error' },
  { inputs: [], name: 'MaxOI', type: 'error' },
    ...
    inputs: [
      { internalType: 'bytes32', name: '_marketId', type: 'bytes32' },
      {
        components: [
          ...
          { internalType: 'uint256', name: 'marketDecimals', type: 'uint256' },
          {
            internalType: 'uint256',
          ...
          { internalType: 'uint256', name: 'closingFee', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'baseCoeff', type: 'uint256' },
      { internalType: 'uint256', name: 'baseConst', type: 'uint256' },
      { internalType: 'uint256', name: 'dynamicCoeff', type: 'uint256' },
      { internalType: 'uint256', name: 'maxDynamicBorrowFee', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'dynamicBorrowRate', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'deviationCoeff', type: 'uint256' },
      { internalType: 'uint256', name: 'deviationConst', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'maximumOi', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'getMarketData',
    outputs: [
      { internalType: 'uint256', name: 'total_longs', type: 'uint256' },
      { internalType: 'uint256', name: 'total_shorts', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'marketId', type: 'bytes32' }],
    name: 'getMarketSkew',
    outputs: [{ internalType: 'uint256', name: 'skew', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [{ internalType: 'bool', name: 'isMarketLive', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'deviationPerc', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: '_marketId', type: 'bytes32' },
      { internalType: 'uint256', name: '_baseCoeff', type: 'uint256' },
      { internalType: 'uint256', name: '_baseConst', type: 'uint256' },
      { internalType: 'uint256', name: '_dynamicCoeff', type: 'uint256' },
      {
        internalType: 'uint256',
  ...
  },
  {
    inputs: [
      { internalType: 'bytes32', name: '_marketId', type: 'bytes32' },
      { internalType: 'uint256', name: '_deviationCoeff', type: 'uint256' },
      { internalType: 'uint256', name: '_deviationConst', type: 'uint256' },
    ],
